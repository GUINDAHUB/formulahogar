...
const PoliticasPage = () => {
  return (
    <div className="bg-white min-h-screen font-sans text-[#141313]">
        {/* Header/Nav back */}
        <div className="container mx-auto px-6 py-8">
            <Link href="/" className="inline-flex items-center gap-2 text-[#141313] hover:text-[#545454] transition-colors font-medium">
        ...
        <div className="container mx-auto px-6 max-w-4xl pb-20">
            <h1 className="font-display text-4xl md:text-5xl font-bold text-[#141313] mb-12">Políticas y Privacidad</h1>

            <div className="space-y-12">
                {/* AVISO LEGAL */}
                <section id="aviso-legal" className="space-y-6">
                    <h2 className="font-display text-2xl font-bold text-[#141313] border-b border-[#D6D6D6] pb-4">Aviso Legal</h2>
                    <div className="prose text-[#545454] max-w-none">
                        <p>
                        ...
                        <h3 className="text-lg font-bold text-[#141313] mt-6 mb-2">1. Datos Identificativos</h3>
                        <p>
                        ...
                        <h3 className="text-lg font-bold text-[#141313] mt-6 mb-2">2. Propiedad Intelectual e Industrial</h3>
                        <p>
                        ...
                        <h3 className="text-lg font-bold text-[#141313] mt-6 mb-2">3. Condiciones de Uso</h3>
                        <p>
                ...
                <section id="privacidad" className="space-y-6">
                    <h2 className="font-display text-2xl font-bold text-[#141313] border-b border-[#D6D6D6] pb-4">Política de Privacidad</h2>
                    <div className="prose text-[#545454] max-w-none">
                        <p>
                        ...
                        <h3 className="text-lg font-bold text-[#141313] mt-6 mb-2">1. Responsable del Tratamiento</h3>
                        <p>
                            <strong>Identidad:</strong> Fórmula Hogar<br />
                            <strong>Email:</strong> hola@formulahogar.com
                        </p>

                        <h3 className="text-lg font-bold text-[#141313] mt-6 mb-2">2. Información que Recopilamos</h3>
                        <p>
                        ...
                        <h3 className="text-lg font-bold text-[#141313] mt-6 mb-2">3. Finalidad del Tratamiento</h3>
                        <p>
                        ...
                        <h3 className="text-lg font-bold text-[#141313] mt-6 mb-2">4. Legitimación</h3>
                        <p>
                        ...
                        <h3 className="text-lg font-bold text-[#141313] mt-6 mb-2">5. Destinatarios</h3>
                        <p>
                        ...
                        <h3 className="text-lg font-bold text-[#141313] mt-6 mb-2">6. Derechos</h3>
                        <p>
